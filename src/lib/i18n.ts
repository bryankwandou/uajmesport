...
export type Dict = {
  ...
  gallery: { kicker: string; title: string; titleEm: string; sub: string; all: string; more: string; less: string; empty: string };
...
const id: Dict = {
  ...
  hero: {
    ...
    ctaPrimary: "Daftar Anggota {REG}", ctaSecondary: "Lihat prestasi",
  ...
  gallery: {
    kicker: "Galeri", title: "Dokumentasi", titleEm: "kegiatan",
    sub: "Momen latihan, turnamen, prestasi dan unggahan media sosial UKM E-Sport UAJM.",
  ...
  officers: {
    kicker: "Pengurus", title: "Kepengurusan periode", titleEm: "{TERM}",
  ...
  cta: {
    kicker: "Pendaftaran Anggota {REG}", title: "Pendaftaran anggota", titleEm: "dibuka",
    ...
    register: "Daftar Anggota {REG}", instagram: "Instagram @uajm_esport", bcc: "Divisi Web3 (BCC)",
  },
...
const en: Dict = {
  ...
  hero: {
    ...
    ctaPrimary: "Register for {REG}", ctaSecondary: "See achievements",
  ...
  gallery: {
    kicker: "Gallery", title: "Activity", titleEm: "documentation",
    sub: "Training sessions, tournaments, achievements and social posts from UKM E-Sport UAJM.",
  ...
  officers: {
    kicker: "Board", title: "Board for the", titleEm: "{TERM} term",
  ...
  cta: {
    kicker: "Membership {REG}", title: "Membership", titleEm: "registration is open",
    ...
    register: "Register for {REG}", instagram: "Instagram @uajm_esport", bcc: "Web3 division (BCC)",
  },
...
const zh: Dict = {
  ...
  hero: { ...en.hero, title1: "正式。", title2: "有组织。", title3: "有竞争力。",
    ...
    ctaPrimary: "报名 {REG}", ctaSecondary: "查看成绩", cabinet: "奖杯陈列" },
  ...
  officers: { ...en.officers, kicker: "干部 {TERM}", title: "组织", titleEm: "架构", division: "部门", coordinator: "协调员" },
...
const ja: Dict = {
  ...
  hero: { ...en.hero, title1: "公式。", title2: "組織的。", title3: "競技志向。",
    ...
    ctaPrimary: "{REG} 登録", ctaSecondary: "実績を見る", cabinet: "トロフィー棚" },
  ...
  officers: { ...en.officers, kicker: "役員 {TERM}", title: "組織", titleEm: "体制", division: "部門", coordinator: "コーディネーター" },
...
const ko: Dict = {
  ...
  hero: { ...en.hero, title1: "공식.", title2: "체계적.", title3: "경쟁적.",
    ...
    ctaPrimary: "{REG} 가입", ctaSecondary: "성과 보기", cabinet: "트로피 진열장" },
  ...
  officers: { ...en.officers, kicker: "임원 {TERM}", title: "조직", titleEm: "구조", division: "부문", coordinator: "코디네이터" },
...
const es: Dict = {
  ...
  hero: { ...en.hero, title1: "Oficial.", title2: "Estructurado.", title3: "Competitivo.",
    ...
    ctaPrimary: "Inscríbete {REG}", ctaSecondary: "Ver logros", cabinet: "Vitrina de trofeos" },
  ...
  officers: { ...en.officers, kicker: "Directiva {TERM}", title: "Estructura", titleEm: "organizativa", division: "División", coordinator: "Coordinador" },
...
const fr: Dict = {
  ...
  hero: { ...en.hero, title1: "Officiel.", title2: "Structuré.", title3: "Compétitif.",
    ...
    ctaPrimary: "S'inscrire {REG}", ctaSecondary: "Voir le palmarès", cabinet: "Vitrine des trophées" },
  ...
  officers: { ...en.officers, kicker: "Bureau {TERM}", title: "Structure", titleEm: "de l'association", division: "Division", coordinator: "Coordinateur" },
...
const de: Dict = {
  ...
  hero: { ...en.hero, title1: "Offiziell.", title2: "Strukturiert.", title3: "Wettbewerbsstark.",
    ...
    ctaPrimary: "Anmelden {REG}", ctaSecondary: "Erfolge ansehen", cabinet: "Pokalvitrine" },
  ...
  officers: { ...en.officers, kicker: "Vorstand {TERM}", title: "Organisations", titleEm: "struktur", division: "Abteilung", coordinator: "Koordinator" },
...
const pt: Dict = {
  ...
  hero: { ...en.hero, title1: "Oficial.", title2: "Estruturado.", title3: "Competitivo.",
    ...
    ctaPrimary: "Inscreva-se {REG}", ctaSecondary: "Ver conquistas", cabinet: "Vitrine de troféus" },
  ...
  officers: { ...en.officers, kicker: "Diretoria {TERM}", title: "Estrutura", titleEm: "organizacional", division: "Divisão", coordinator: "Coordenador" },
...
const ar: Dict = {
  ...
  hero: { ...en.hero, title1: "رسمي.", title2: "منظّم.", title3: "تنافسي.",
    ...
    ctaPrimary: "سجّل {REG}", ctaSecondary: "اطّلع على الإنجازات", cabinet: "خزانة الكؤوس" },
  ...
  officers: { ...en.officers, kicker: "الإدارة {TERM}", title: "الهيكل", titleEm: "التنظيمي", division: "قسم", coordinator: "منسّق" },
